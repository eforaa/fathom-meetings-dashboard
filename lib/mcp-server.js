...
Поиск ВСЕХ встреч человека (важно):
...
- Меняй только безымянные встречи; уже названные не трогай. Сначала назови 3–5 штук, покажи «старое → новое», дождись «ок», потом продолжай.`;
