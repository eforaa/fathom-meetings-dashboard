...
- Меняй только безымянные встречи («No name»/«Impromptu Zoom Meeting»); уже названные НЕ трогай. Сначала назови 3–5 штук, покажи «старое → новое», дождись «ок», потом продолжай.`;
