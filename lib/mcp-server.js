...
- Порядок показа: custom_title → ai_title → оригинал → «No name». Так ручное имя всегда побеждает, а оригинал не затирается.

Короткие названия безымянным встречам («Impromptu Zoom Meeting»):
- Заголовок = суть темы (3–5 слов, без глаголов) + фамилии 1–3 ключевых участников в скобках. Пример: «Плагин Fathom — синхронизация данных (Погорелый, Олийник, Веденеева)».
...
- Пиши сгенерированные имена через set_meeting_title с generated:true (метка 🤖). Меняй только безымянные встречи («No name»/«Impromptu Zoom Meeting»); уже названные НЕ трогай. Сначала назови 3–5 штук, покажи «старое → новое», дождись «ок», потом продолжай.`;
